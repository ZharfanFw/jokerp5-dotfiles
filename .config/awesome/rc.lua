...
local editor = os.getenv("visudo") or "nvim"
...
globalkeys = mytable.join(
	...
	awful.key({}, "Print", function()
		awful.spawn.with_shell("sleep 0.2 && scrot -s ~/Pictures/screenshots/%Y%m%d_%H%M%S.png") -- Capture selected area
	end),
	...
	-- Volume control (PipeWire via wpctl)
	...
	awful.key({ modkey }, "space", function()
		awful.spawn("/home/zharfanfw/.config/rofi/launchers/type-6/launcher.sh")
	end, { description = "launch rofi", group = "launcher" }),

	-- powermenu
	awful.key({ modkey }, "x", function()
		awful.spawn("/home/zharfanfw/.config/rofi/powermenu/type-6/powermenu.sh")
	end, { description = "spawn powermenu", group = "launcher" })
	--]]
)
...
-- Signal function to make a bar disappear
...
client.connect_signal("unmanage", function(c)
	local s = c.screen
	if s.mywibox and not c.fullscreen then
...
awful.spawn.with_shell("feh --bg-fill /home/zharfanfw/Downloads/Wallpaper/wall2.png") -- Feh Wallpaper
awful.spawn.with_shell("nm-applet") -- Network Manager
awful.spawn.with_shell("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1") -- Policy Kit
awful.spawn.with_shell("dbus-launch --sh-syntax --exit-with-session") -- Volman Automount Disk
